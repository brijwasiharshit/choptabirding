...
const DiscoverSection = () => {
  return (
    <section className="container mx-auto px-4 md:px-20 py-10 md:py-20 bg-white">
      <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-center">
        ...
        <motion.div
          ...
          <div className="overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-200">
            <img
        ...
        <motion.div
          ...
          <div className="bg-gray-50 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 border border-gray-200">
            <h2 className="text-3xl md:text-4xl font-bold text-[#2a6496] mb-6 font-serif">
              Discover the <span className="text-[#f4a261]">Beauty</span> of
              Chopta
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              At <strong>Chopta Birding</strong>, we organize immersive
              birdwatching tours from <strong>Dehradun to Chopta</strong>,
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-8 bg-[#2a6496] hover:bg-[#3a74a6] text-white px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 border-2 border-[#2a6496]/50">
